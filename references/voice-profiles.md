# Voice profiles — how attribution changes by contributor type

The skill asks the contributor's type once (interview job b), then applies the matching profile to
every generated string. The voice/attribution gate checks each draft against the profile below.

The whole distinction turns on one question: **who is "we"?** Getting that right is what keeps a
partner or community contributor from accidentally implying they *are* Tenable or that Tenable
...
- ❌ "Our RBVM tool…" (abbreviation banned; spell out the product name in full on first reference)

## Note on own-org "we"

A community or partner contributor saying **"we cut our MTTR 88%"** is stating *their own team's*
firsthand result — **keep it**. Do not stiffen it to third person. The gate only intervenes when
the phrasing implies the contributor *is* Tenable or that Tenable endorses the asset.
